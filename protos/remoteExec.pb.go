...
var fileDescriptor_8429525101601a29 = []byte{
	...
	,
}
...
type RemoteExecClient interface {
	...
	IsServerRunning(ctx context.Context, in *Service, opts ...grpc.CallOption) (*IsRunning, error)
}
...
func (c *remoteExecClient) IsServerRunning(ctx context.Context, in *Service, opts ...grpc.CallOption) (*IsRunning, error) {
	out := new(IsRunning)
	err := c.cc.Invoke(ctx, "/protos.RemoteExec/IsServerRunning", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RemoteExecServer interface {
	...
	IsServerRunning(context.Context, *Service) (*IsRunning, error)
}
...
func (*UnimplementedRemoteExecServer) IsServerRunning(ctx context.Context, req *Service) (*IsRunning, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IsServerRunning not implemented")
}
...
func _RemoteExec_IsServerRunning_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Service)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RemoteExecServer).IsServerRunning(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.RemoteExec/IsServerRunning",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RemoteExecServer).IsServerRunning(ctx, req.(*Service))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RemoteExec_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IsServerRunning",
			Handler:    _RemoteExec_IsServerRunning_Handler,
		},
	},
